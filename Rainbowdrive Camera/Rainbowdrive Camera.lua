...
lofi = GetQualityLevel() > 1 -- GetQualityLevel returns 1,2,or 3
function iflofi(if_true, if_false)
  if lofi then return if_true else return if_false end
end
...
ufi = GetQualityLevel() > 3 -- GetQualityLevel returns 1,2,or 3
function ifufi(if_true, if_false)
  if ufi then return if_true else return if_false end
end
...
--	radialblur_strength = fif(jumping,2,0),
	...
	airdebris_count = 1000,
	airdebris_density = 40,
...
{										--Waltz
	{r=0, g=0, b=0},
    {r=200, g=10, b=40}, --hot magenta
    {200,18,100},--magenta
	{0,0,0},
    {r=200, g=30, b=100},--purple
	--{250,43,239},--Rose Fuchsia
	{31,94,86}, --ocean green
    {r=200, g=20, b=190},--purple
    {25,25,112},--blue
    {r=100, g=15, b=200},--dark purple
    {r=39, g=45, b=200},--another blue
    {r=0, g=183, b=104},--seafoam green
    {r=29, g=96, b=173},
},
{										--Hyper
{r=0, g=0, b=0},
    {r=200, g=30, b=15}, --red orange
    {r=246, g=159, b=15},--orange
    {r=200, g=10, b=40}, --hot magenta
    {0,0,0},
    {r=200, g=30, b=100},--purple
    {r=246, g=159, b=15},--orange
    ...
    {r=100, g=15, b=200},--dark purple
    {r=39, g=45, b=200},--another blue
    {r=33, g=210, b=130},--seafoam green
    {r=200,g=30,b=15},--cool red
    {r=0, g=0, b=0},
},

{										--Nova
    {r=0, g=0, b=0},
	{r=69, g=13, b=96},--black magenta
        {r=3, g=37, b=77},--deep blue
		{r=0, g=30, b=100},--less deep blue
    {r=0, g=60, b=174},--blue
    {r=0, g=60, b=130},--deep blue
    {r=150, g=0, b=0},--dark red
    {r=0, g=60, b=120},--dark blue
    {r=0, g=0, b=0},
        {140,20,20}, --crimson
    --{r=100, g=60, b=130},--deep blue
    --{r=50, g=50, b=130},--very dark blue
{r=0, g=20, b=180},
        {r=104, g=0, b=148},--dark magenta
{r=0, g=25, b=150},
--{r=25, g=40, b=180},
{r=25, g=50, b=112}, --dark violet
    {r=0, g=60, b=255},--bright blue
 {r=75, g=0, b=130},
},
{										--Inferno
{r=0, g=0, b=0},
{r=50, g=50, b=50}, --dark grey
{r=90, g=90, b=90}, --grey
{58,16,61}, --dark violet
    {r=50, g=0, b=0}, --black red
    {r=100, g=0, b=10},--dark red
{0,0,0},
{r=50, g=50, b=50}, --dark grey
{r=90, g=90, b=90}, --grey
...
{0,0,0},
{222,199,69}, --yellow
{199,165,64}, --darker yellow
{32,145,139}, --teal
{61,92,110}, --pine tree
{41,60,75}, --dark green
--{47,27,74}, --dark purple*
{99,2,99}, --dark purple
{49,78,146}, --deep blue
{0,0,0},
{80,110,134}, --grey
...
if buildingNodes == nil then
	...
	for i=1,#track do
		if i%80==0 then	
			...
			local xOffset = 1000*math.random(0.5,5)
			if math.random() > 2.25 then xOffset = xOffset * -1 end
			offsets[#offsets+1] = {xOffset,-100,0}
			
			local yOffset = 1000*math.random(0.5,5)
			if math.random() > 2.25 then yOffset = yOffset * -1 end
