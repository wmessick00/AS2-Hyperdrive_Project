...
--	radialblur_strength = fif(jumping,2,0),
	...
	airdebris_density = ifhifi(50,20),
...
--    {r=93, g=8, b=132}, --purple
--    {r=0.125, g=0.46, b=0.77},
...
SetPuzzleGraphics{
	...
	puzzlematerial = {shader="VertexColorUnlitTintedAlpha",texture="tilesSquare.png",shadercolors={_Color={255,255,255,255}}}
}
...
CreateObject{
	...
	gameobject={
		...
		shadercolors={
			--_Color={0,0,0},
			_Color={colorsource="highway", scaletype="intensity", minscaler=1, maxscaler=6, param="_Threshold", paramMin=2, paramMax=2},
			_RimColor={1,1,1}
		}
	}
}
...
if not jumping then
	CreateRail{--road surface
		...
		--texture="subroad.png",
		shader="VertexColorUnlitTintedAlpha",
		shadercolors={_Color={r=30,g=30,b=30,a=30}}
	}
